window.onload = function () {
  ...
  card.innerHTML = `
    ...
    <h3> Your streetaddress :<span>${data.streetaddress}</span></h3> 
    <h3> Your City :<span>${data.City}</span></h3> 
    <h3> Your Password :<span>${data.Password}</span></h3>
    <h3> Your SecurityQuestion :<span>${data.security_question}</span></h3> 
    <h3> Your SecurityAnswer :<span>${data.SecurityAnswer}</span></h3>
  `;
